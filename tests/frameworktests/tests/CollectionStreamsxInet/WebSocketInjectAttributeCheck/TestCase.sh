...
errorCodes=(
	"*CDIST3865E Port Attribute message must be of type rstring, ustring or blob*"
	...
	"*CDIST3865E Port Attribute messageAttribute must be of type rstring, ustring or blob*"
